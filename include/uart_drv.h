...
/* uart_drv.h
 *
 * UART driver public API and convenient baud constants. The low-level
 * driver exposes blocking transmit/receive functions and an init
 * function. All operations are hardware-specific and rely on the
 * LM3S6965 memory map and register definitions.
 */
